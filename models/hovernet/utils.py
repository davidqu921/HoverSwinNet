...
def xentropy_loss(true, pred, reduction="mean"):
    ...
    # print(f"The shape of pred is {pred.shape}, the shape of true is {true.shape}")
...
####
def dice_loss(true, pred, smooth=1e-3): # //////////////////////////// 传入ground truth : true_np_onehot, true_hv,true_tp_onehot ///////////////////
