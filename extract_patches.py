...
if __name__ == "__main__":
    ...
    win_size = [256, 256]    # <------针对我们256*256的图片大小可以换成128*128的窗口大小
    step_size = [256, 256]   # <------ 换成128*128的步长
    extract_type = "valid"  # Choose 'mirror' or 'valid'. 'mirror'- use padding at borders. 'valid'- only extract from valid regions.

    # Name of dataset - use Kumar, CPM17 or CoNSeP, Pannuke.
    # This used to get the specific dataset img and ann loading scheme from dataset.py
    dataset_name = "pannuke"
    save_root = "/data3/davidqu/python_project/hover_net/F1_train_data/%s/" % dataset_name

    # a dictionary to specify where the dataset path should be
    dataset_info = {
        "train": {
            "img": (".png", "/data3/davidqu/python_project/hover_net/F1_Train/Images"),
            "ann": (".mat", "/data3/davidqu/python_project/hover_net/F1_Train/Lables"),
        },
        "valid": {
            "img": (".png", "/data3/davidqu/python_project/hover_net/F1_Test/Images"),
            "ann": (".mat", "/data3/davidqu/python_project/hover_net/F1_Test/Lables"),
        },
    }
