...
class __Pannuke(__AbstractDataset):
    """  Defines the PanNuke dataset for instance segmentation and classification.
    PanNuke dataset contains 19 tissue types and 5 nuclear classes.
